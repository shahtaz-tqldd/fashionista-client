    ...
    <section className='h-[70vh] w-full flex items-center justify-center'>
      <div className='flex rounded-lg bg-white shadow-lg h-[450px] w-[700px]' data-aos="fade-right">
        <div className='lg:w-1/2 p-8'>
          ...
          <form>
            <input type="text" placeholder="Your Full Name" className="input input-bordered w-full mb-2" />
        ...
        <div className='lg:w-1/2 bg-primary rounded-r-lg flex items-center justify-center lg:flex md:flex hidden'>
