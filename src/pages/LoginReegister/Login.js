...
const Login = () => {
  ...
  return (
    <section className='h-[70vh] w-full flex items-center justify-center'>
      <div className='flex rounded-lg bg-white shadow-lg h-[400px] w-[700px]' data-aos="fade-left">
        ...
        <div className='lg:w-1/2 bg-primary rounded-r-lg items-center justify-center lg:flex md:flex hidden'>
